...
function getFileUrl(filename) {
  ...
  return `${baseUrl}/file/${cleanFilename}`;
}
            ...
            {data.homework.file && (
              <Button
                ...
                sx={{
                  ...
                  borderColor: '#c5a059',
                  fontWeight: 600,
                  '&:hover': { borderColor: '#b89350', background: '#faede0' }
                }}
              >
                Vazifa fayli
              </Button>
      ...
      <Paper elevation={0} sx={{ border: '1px solid #e5e7eb', borderRadius: '16px', p: 3, mb: 3 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            <Avatar sx={{ width: 40, height: 40, backgroundColor: '#c5a059', fontWeight: 700, fontSize: '1rem' }}>
        ...
        {data.status === 'not_done' ? (
          ...
          <>
                    ...
                    isImage(f) ? (
                      ...
                      <Box
                        ...
                        sx={{
                          ...
                          transition: 'all 0.2s',
                          '&:hover': { borderColor: '#c5a059', color: '#c5a059', background: '#faede0' },
                        }}
                      >
            ...
            {data.answer?.comment && (
              <Box sx={{
                borderLeft: '3px solid #c5a059', pl: 2, py: 1,
      ...
      >
        <DialogTitle sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', py: 1.5, px: 2.5, borderBottom: '1px solid #f3f4f6' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <InsertDriveFileIcon sx={{ color: '#c5a059' }} />
            ...
            if (isArchive) {
              return (
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', py: 8, gap: 2.5, px: 3, textAlign: 'center' }}>
                  <Box sx={{ p: 2, borderRadius: '50%', backgroundColor: '#faede0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
