            ...
            <TableBody>
              {paginated.length === 0 ? (
                ...
                <TableRow key={user.id} hover sx={{ '&:last-child td': { border: 0 } }}>
                  ...
                  <TableCell>
                    <Typography sx={{ fontSize: '0.8rem', fontWeight: 600, color: user.role === 'SUPERADMIN' ? '#d97706' : '#c5a059' }}>
                      {user.role}
                    </Typography>
                  </TableCell>
                  ...
                  <TableCell>
                    {activeTab === 'archive' ? (
                      ...
                      <Stack direction="row" spacing={0.5}>
                        <IconButton size="small" sx={{ color: '#9ca3af', '&:hover': { color: '#c5a059' } }} onClick={() => openEditDrawer(user)}>
        ...
        <Box sx={{ p: 3, overflowY: 'auto', flex: 1 }}>
          <Stack spacing={2.5}>
            ...
            <Box>
              ...
              <TextField fullWidth size="small" placeholder="Masalan: admin@crm.uz"
